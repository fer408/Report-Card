...
public class CSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Grade("Midterm", "24 out of 30"));
        words.add(new Grade("Final", "31 out of 35"));
        words.add(new Grade("Total", "87 out of 100"));
        words.add(new Grade("Congrats", "You got a B plus "));
